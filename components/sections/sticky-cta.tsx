...
const ACTIONS = [
  ...
  },
  {
    id: "telegram",
    label: "Telegram",
    href: "https://t.me/concept25",
    className: "bg-[#2AABEE] text-white hover:brightness-110",
    icon: TelegramIcon,
  },
] as const;
    ...
    <div ref={rootRef} className="fixed bottom-5 right-5 z-40">
      <div className="relative flex flex-col-reverse items-center gap-3">
        <button
          ...
          className="flex h-14 w-14 items-center justify-center rounded-full bg-primary text-white shadow-[0_16px_40px_-12px_rgba(11,110,79,0.7)] transition hover:bg-primary-dark"
        >
          <motion.span
